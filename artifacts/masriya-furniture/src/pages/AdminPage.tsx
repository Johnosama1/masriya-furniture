...
import { LogOut, Plus, Pencil, Trash2, X, ImagePlus, Tag, MinusCircle } from "lucide-react";
    ...
    <div className="min-h-screen bg-background text-foreground" dir="rtl">
      ...
      <div className="sticky top-0 z-30 bg-card border-b border-border px-3 sm:px-4 py-2.5 sm:py-3 flex items-center justify-between shadow-md gap-2" dir="rtl">
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <Badge variant="outline" className="text-muted-foreground text-xs hidden sm:flex">{products?.length ?? 0} منتج</Badge>
        </div>
        ...
        <DialogContent className="max-w-2xl max-h-[92vh] overflow-y-auto" dir="rtl">
          ...
          <div className="space-y-5 pt-2">
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  disabled={uploading}
                  className="flex-1 border-2 border-dashed border-border rounded-xl p-4 text-center hover:border-primary hover:bg-primary/5 transition-all cursor-pointer disabled:opacity-50"
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              <div className="space-y-1">
                ...
                <Input
                  ...
                  placeholder="مثال: غرفة أطفال فيروزي"
                />
              </div>
              <div className="space-y-1">
                ...
                <Input
                  ...
                  placeholder="e.g. turquoise kids room"
                />
              </div>
            </div>
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-muted-foreground">كل قطعة في سطر منفصل، واكتب | بين القطع أو افصل بسطر جديد</p>
              <Textarea
                rows={4}
              ...
              <p className="text-xs text-muted-foreground/60">
                كل سطر يقابل صورة — الأول مع الصورة الأولى، الثاني مع الثانية...
              </p>
            </div>

            {/* Measurements auto-format helper */}
