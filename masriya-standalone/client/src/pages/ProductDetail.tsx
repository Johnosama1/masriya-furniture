...
export default function ProductDetail() {
  ...
  const pieceLabelMap: Record<string, string> = {
    دولاب: "الدولاب", سرير: "السرير", كمود: "الكمود",
    بانكيت: "البانكيت", تسريحة: "التسريحة", كنبة: "الكنبة",
    كرسي: "الكرسي", ركنة: "الركنة", بوفيه: "البوفيه",
    مكتب: "المكتب", طاولة: "الطاولة",
  };
                ...
                >
                  {pieceLabel && (
                    <div className="flex items-center gap-3 justify-center">
                      ...
                      <span className="text-primary font-bold text-base sm:text-lg px-3 sm:px-4">{pieceLabel}</span>
                      <div className="h-px flex-1 bg-primary/30" />
                    </div>
                  )}
                  <div
